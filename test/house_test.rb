...
class HouseTest < Minitest::Test
  ...
  def test_it_can_determine_above_market_value?
    house = House.new("$400000", "123 sugar lane")

    assert_equal false, house.above_market_value?
  end

  def test_it_can_return_rooms_from_categories
    house = House.new("$400000", "123 sugar lane")
    room_1 = Room.new(:bedroom, 10, '13')
    room_2 = Room.new(:bedroom, 11, '15')
  ...
  def test_it_can_calculate_area_of_house
    house = House.new("$400000", "123 sugar lane")
    room_1 = Room.new(:bedroom, 10, '13')
    room_2 = Room.new(:bedroom, 11, '15')
    room_3 = Room.new(:living_room, 25, '15')
  ...
  def test_it_can_return_rooms_sorted_by_category
    house = House.new("$400000", "123 sugar lane")
    room_1 = Room.new(:bedroom, 10, '13')
    room_2 = Room.new(:bedroom, 11, '15')
    room_3 = Room.new(:living_room, 25, '15')
